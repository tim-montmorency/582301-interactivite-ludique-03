...
*   **Maintenir la logique centrale dans les nœuds racines d'une scène**. Ces nœuds orchestrent le comportement de leurs enfants et doivent être le seul nœud avec un script (en général).
